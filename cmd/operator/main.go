...
var (
	...
	Command = &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{Destination: &cfg.Config.BackupPriorityClassName, Name: "backup-priority-class-name-annotation", EnvVars: []string{"BACKUP_PRIORITY_CLASS_NAME_ANNOTATION"}, Value: "k8up.io/backup-priority-class-name", Usage: "set the annotation name that set priorityClassName for backups"},
