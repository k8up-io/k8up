...
var (
	...
	Command = &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{Name: "operator-namespace", EnvVars: []string{"BACKUP_OPERATOR_NAMESPACE"}, Required: false, Usage: "(DEPRECATED) set the namespace in which the K8up operator itself runs"},
		},
	}
)
