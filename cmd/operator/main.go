...
var (
	...
	Command = &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.IntFlag{Destination: cfg.Config.GlobalKeepJobs, Hidden: true, Name: "globalkeepjobs", EnvVars: []string{"BACKUP_GLOBALKEEPJOBS"}, DefaultText: "unlimited", Usage: "set the number of old jobs to keep when cleaning up, applies to all job types"},
