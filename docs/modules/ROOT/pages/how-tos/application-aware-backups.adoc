...
It is able to dump all the database contents into an https://www.mongodb.com/blog/post/archiving-and-compression-in-mongodb-tools[proprietary binary archive] in a consistent state.
...
[source,bash]
----
$ oc port-forward po/mongodb-0 27017:27017
