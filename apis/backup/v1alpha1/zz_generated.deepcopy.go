...
func (in *Archive) DeepCopyInto(out *Archive) {
	*out = *in
	...
	if in.GlobalOverrides != nil {
		in, out := &in.GlobalOverrides, &out.GlobalOverrides
		if *in == nil {
			*out = nil
		} else {
			*out = new(GlobalOverrides)
			(*in).DeepCopyInto(*out)
		}
	}
	return
...
func (in *GlobalOverrides) DeepCopyInto(out *GlobalOverrides) {
	*out = *in
	if in.RegisteredBackend != nil {
		in, out := &in.RegisteredBackend, &out.RegisteredBackend
		if *in == nil {
			*out = nil
		} else {
			*out = new(Backend)
...
func (in *Restore) DeepCopyInto(out *Restore) {
	*out = *in
	...
	out.Status = in.Status
	in.GlobalOverrides.DeepCopyInto(&out.GlobalOverrides)
	return
}
