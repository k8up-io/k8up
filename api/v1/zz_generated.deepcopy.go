...
func (in *EffectiveScheduleList) DeepCopy() *EffectiveScheduleList {
	if in == nil {
		return nil
	}
	out := new(EffectiveScheduleList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EffectiveScheduleSpec) DeepCopyInto(out *EffectiveScheduleSpec) {
	*out = *in
	if in.ScheduleRefs != nil {
		...
		*out = make([]ScheduleRef, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EffectiveScheduleSpec.
func (in *EffectiveScheduleSpec) DeepCopy() *EffectiveScheduleSpec {
	if in == nil {
		return nil
	}
	out := new(EffectiveScheduleSpec)
	in.DeepCopyInto(out)
	return out
}
