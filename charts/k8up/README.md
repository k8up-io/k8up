...
![Version: 4.8.8](https://img.shields.io/badge/Version-4.8.8-informational?style=flat-square)
...
```
```bash
kubectl apply -f https://github.com/k8up-io/k8up/releases/download/k8up-4.8.8/k8up-crd.yaml --server-side
```
