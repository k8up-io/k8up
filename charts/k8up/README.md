...
![Version: 4.10.0](https://img.shields.io/badge/Version-4.10.0-informational?style=flat-square)
...
| image.tag | string | `"v2.16.0"` | Operator image tag (version) |
...
| k8up.repositorySecretName | string | `""` | Specifies the name of the Secret that contains repository configuration values (e.g. S3 endpoint and bucket). Defaults to `k8up-repo` if left empty. |
