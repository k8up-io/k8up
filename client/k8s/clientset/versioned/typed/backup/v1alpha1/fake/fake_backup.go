...
var backupsResource = schema.GroupVersionResource{Group: "appuio.ch", Version: "v1alpha1", Resource: "backups"}

var backupsKind = schema.GroupVersionKind{Group: "appuio.ch", Version: "v1alpha1", Kind: "Backup"}
