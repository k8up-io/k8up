...
var restoresResource = schema.GroupVersionResource{Group: "appuio.ch", Version: "v1alpha1", Resource: "restores"}

var restoresKind = schema.GroupVersionKind{Group: "appuio.ch", Version: "v1alpha1", Kind: "Restore"}
