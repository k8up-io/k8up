...
var schedulesResource = schema.GroupVersionResource{Group: "appuio.ch", Version: "v1alpha1", Resource: "schedules"}

var schedulesKind = schema.GroupVersionKind{Group: "appuio.ch", Version: "v1alpha1", Kind: "Schedule"}
